...
function check_button(){
	...
	if(button==2){
		$("#filter-all").addClass(button_class);
		$("#gallery-header-center-left-title").html('Pre-Wedding');
		}
	if(button==3){
	...
	if(button==4){
		...
		$("#gallery-header-center-left-title").html('Evening');
		}	
}
...
$("#filter-prew").click(function() {  $container.isotope({ filter: '.prew' }); button = 2; check_button();  });
$("#filter-rec").click(function() {  $container.isotope({ filter: '.rec' }); button = 3; check_button();  });
$("#filter-eve").click(function() {  $container.isotope({ filter: '.eve' }); button = 4; check_button();  });
